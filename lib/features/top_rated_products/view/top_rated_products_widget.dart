...
import 'package:atomshop/features/top_rated_products/controller/top_rated_products_controller.dart';
...
class TopRatedProductsWidget extends StatelessWidget {
  final TopRatedProductsController controller =
      Get.put(TopRatedProductsController());

  TopRatedProductsWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      if (controller.topRatedProducts.isEmpty) {
      ...
      return SizedBox(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return TopRatedProductCard(product: product);
          },
        ),
      );
    });
...
class TopRatedProductCard extends StatelessWidget {
  final TopRatedProductsModel product;
